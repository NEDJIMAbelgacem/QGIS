...
QgsTessellatedPolygonGeometry::QgsTessellatedPolygonGeometry( bool _invertNormals, bool _addBackFaces, bool _addTextureCoords, QNode *parent )
...
#endif
//  invertNormals = false, bool addBackFaces = false, bool addTextureCoords = false
